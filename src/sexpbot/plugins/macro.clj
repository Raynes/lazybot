  ...
  (:macro
   ...
   (let [macro-name (first args)
	 ...
	 (do
	   ...
	   (send-message irc channel (str "Added macro: " macro-name))))
       (send-message irc channel (str nick ": please provide a macro name and body!")))))
   ...
   (:macroexpand
    ...
    (let [macro-name (first args)
      ...
      (if (seq macro-body)
	(send-message irc channel (str nick ": " macro-name " => " macro-body))
	(send-message irc channel (str nick ": that macro doesn't exist!"))))))
